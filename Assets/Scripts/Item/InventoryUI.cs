...
public abstract class InventoryUI : MonoBehaviour
{
    ...
    public void OnEndDrag(GameObject go)
    {
        ...
        {
            InventorySlot mouseHoverSlotDate = MouseData.interfaceMouseIsOver.slotUIs[MouseData.slotHoveredOver];
            inventoryObject.SwapItems(slotUIs[go], mouseHoverSlotDate);
        }
    }
